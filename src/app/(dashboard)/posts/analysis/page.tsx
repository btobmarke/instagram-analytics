...
function AnalysisContent() {
  ...
  // グリッドカラム数（最大3列）
  const colClass = postCount === 1 ? 'grid-cols-1' : postCount === 2 ? 'grid-cols-2' : 'grid-cols-3'
                ...
                {results.map((result, idx) => {
                  ...
                  return (
                    <div key={post.id} className="p-5">
                      ...
                      {/* サムネイル */}
                      <div className="aspect-square w-full bg-gray-100 rounded-xl overflow-hidden mb-3">
                      ...
                      {children && children.length > 1 && (
                        <p className="text-xs text-gray-400 mb-2">カルーセル {children.length}枚</p>
                      )}
