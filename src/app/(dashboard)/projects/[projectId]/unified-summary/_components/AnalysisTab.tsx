...
export function AnalysisTab({
  ...
  // タブ
  const [activeTab, setActiveTab] = useState<'tree' | 'analysis' | 'weights' | 'eval'>('tree')
      ...
      <div className="border-b border-gray-200">
        <div className="flex items-end justify-between gap-2">
          ...
          <Link
            ...
            className="mb-1 flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-purple-600 text-white text-xs font-medium hover:bg-purple-700 transition-colors shadow-sm"
          >
            📊 サマリカード分析
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
