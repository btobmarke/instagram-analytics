...
export default function LineMaFlexDetailPage({
  ...
  if (!isLoading && tplResp?.error === 'not_found') {
    return (
      <div className="p-6">
        ...
        <Link href={`/projects/${projectId}/services/${serviceId}/line/flex`} className="text-green-600 text-sm mt-2 inline-block">
          一覧へ
        </Link>
      </div>
    )
  ...
  return (
    <div className="w-full max-w-none min-w-0">
      <div className="mb-4">
        <Link
          href={`/projects/${projectId}/services/${serviceId}/line/flex`}
