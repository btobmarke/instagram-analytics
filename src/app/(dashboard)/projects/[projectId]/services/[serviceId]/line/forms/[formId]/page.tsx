...
export default function LineMaFormDetailPage({
  ...
  if (!isLoading && formResp && (formResp as { error?: string }).error === 'not_found') {
    return (
      <div className="w-full max-w-none min-w-0">
        ...
        <Link href={`/projects/${projectId}/services/${serviceId}/line/forms`} className="text-green-600 text-sm mt-2 inline-block">
          一覧へ
        </Link>
      </div>
    )
  ...
  return (
    <div className="w-full max-w-none min-w-0">
      <div className="mb-4">
        <Link
          href={`/projects/${projectId}/services/${serviceId}/line/forms`}
