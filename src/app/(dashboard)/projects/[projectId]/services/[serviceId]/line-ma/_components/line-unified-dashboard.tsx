  ...
  return (
    <div className="p-6 w-full max-w-none">
      ...
      <div className="flex items-center gap-1 mb-6 border-b border-gray-200 flex-wrap">
        <span className={tabActive}>ダッシュボード</span>
        <Link href={`${base}/line-ma/contacts`} className={tabInactive}>
          機能（MA）
        </Link>
        <Link href={`${base}/line`} className={tabInactive}>
          設定
        </Link>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-xs text-gray-500 mb-4">
              ...
              <Link href={`${base}/line-ma/analytics`} className="text-green-600 hover:underline">
                分析
              </Link>
              へ。
            </p>
