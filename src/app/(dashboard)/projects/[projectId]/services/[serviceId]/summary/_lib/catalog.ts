...
const IG_ACCOUNT: [string, string, string][] = [
  ...
  ['reach',              'リーチ',                   'Instagram のアカウント単位インサイトにおける「リーチ」。投稿・ストーリー・リールなどコンテンツの露出に基づくユニークアカウント数（プロフィール閲覧数とは別指標）。同じアカウントが複数回見ても1としてカウント。'],
  ...
  ['profile_views',      'プロフィール閲覧数',       'プロフィールページが閲覧された回数。【2026年4月廃止】'],
